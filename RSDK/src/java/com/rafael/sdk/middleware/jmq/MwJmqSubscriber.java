...
/**
 * The Class MwJmqSubscriber.
 */
public class MwJmqSubscriber extends MwSubscriber {

	/** The subscriber. */
	private SocketBase subscriber = null;
	
	/**
	 * Instantiates a new mw jmq subscriber.
	 *
	 ...
	 */
	public MwJmqSubscriber (Ctx context, String connectionType, String connectionString, Component component) {
